...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ...
        resume.getContactSection().put(EnumContacts.CELLPHONE, "+7(921) 855-0482");
        resume.getContactSection().put(EnumContacts.SKYPE, "grigory.kislin");
        resume.getContactSection().put(EnumContacts.EMAIL, "gkislin@yandex.ru");
        resume.getContactSection().put(EnumContacts.LINKENDIN, "");
        resume.getContactSection().put(EnumContacts.GITHUB, "");
        resume.getContactSection().put(EnumContacts.STACKOVERFLOW, "");
        resume.getContactSection().put(EnumContacts.HOMEPAGE, "");

        resume.getDataSection().put(EnumSections.PERSONAL, new TextSection(EnumSections.PERSONAL.getTitel(),
                "Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям"));
        resume.getDataSection().put(EnumSections.OBJECTIVE, new TextSection(EnumSections.OBJECTIVE.getTitel(),
        ...
        resume.getDataSection().put(EnumSections.ACHIEVEMENT,
                new TextSections(EnumSections.ACHIEVEMENT.getTitel(), listAchievement));
        ...
        resume.getDataSection().put(EnumSections.QUALIFICATIONS,
                new TextSections(EnumSections.QUALIFICATIONS.getTitel(), listQualifications));

        ArrayList<CompositeSection> compositeSectionsExperience = new ArrayList<>();
        compositeSectionsExperience.add(new CompositeSection("Java Online Projects",
                YearMonth.parse("2013-10"), YearMonth.now(), "Автор проекта.", "Создание, " +
                "организация и проведение Java онлайн проектов и стажировок."));
        compositeSectionsExperience.add(new CompositeSection("Wrike", YearMonth.parse("2014-10"), YearMonth.parse("2016-01"),
        ...
        compositeSectionsExperience.add(new CompositeSection("RIT Center", YearMonth.parse("2012-04"), YearMonth.parse("2014-10"),
                "Java архитектор", "Организация процесса разработки системы ERP для разных окружений: " +
                        ...
                        "PL/Python"));
        compositeSectionsExperience.add(new CompositeSection("Luxoft (Deutsche Bank)", YearMonth.parse("2010-12"), YearMonth.parse("2012-04"),
        ...
        compositeSectionsExperience.add(new CompositeSection("Yota", YearMonth.parse("2008-06"), YearMonth.parse("2010-12"),
        ...
        compositeSectionsExperience.add(new CompositeSection("Enkata", YearMonth.parse("2007-03"), YearMonth.parse("2008-06"),
        ...
        compositeSectionsExperience.add(new CompositeSection("Siemens AG", YearMonth.parse("2005-01"), YearMonth.parse("2007-02"),
        ...
        compositeSectionsExperience.add(new CompositeSection("Alcatel", YearMonth.parse("1997-09"), YearMonth.parse("2005-01"),
        ...
        resume.getDataSection().put(EnumSections.EXPERIENCE,
                new CompositeSections(EnumSections.EXPERIENCE.getTitel(), compositeSectionsExperience));

        ArrayList<CompositeSection> compositeSectionsEducation = new ArrayList<>();
        compositeSectionsEducation.add(new CompositeSection("Coursera",
                YearMonth.parse("2013-03"), YearMonth.parse("2013-05"), "\"Functional Programming Principles " +
                "in Scala\" by Martin Odersky", ""));
        compositeSectionsEducation.add(new CompositeSection("Luxoft",
        ...
        compositeSectionsEducation.add(new CompositeSection("Siemens AG",
                YearMonth.parse("2005-01"), YearMonth.parse("2005-04"), "3 месяца обучения мобильным " +
                "IN сетям (Берлин)", ""));
        compositeSectionsEducation.add(new CompositeSection("Alcatel",
                YearMonth.parse("1998-09"), YearMonth.parse("1998-09"), "6 месяцев обучения цифровым " +
                "телефонным сетям (Москва)", ""));
        compositeSectionsEducation.add(new CompositeSection("Санкт-Петербургский национальный исследовательский " +
        ...
        compositeSectionsEducation.add(new CompositeSection("Санкт-Петербургский национальный исследовательский " +
                ...
                ""));
        compositeSectionsEducation.add(new CompositeSection("Заочная физико-техническая школа при МФТИ",
                YearMonth.parse("1984-09"), YearMonth.parse("1987-06"), "Закончил с отличием",
                ""));
        resume.getDataSection().put(EnumSections.EDUCATION,
                new CompositeSections(EnumSections.EDUCATION.getTitel(), compositeSectionsEducation));
    }
}
